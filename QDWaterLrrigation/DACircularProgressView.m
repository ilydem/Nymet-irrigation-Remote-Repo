...
- (UIColor *)trackTintColor
{
    if (!_trackTintColor)
    {
        _trackTintColor = [[UIColor colorWithRed:0.8274f green:0.8274f blue:0.8274f alpha:1.0f] retain];
    }
...
- (UIColor *)progressTintColor
{
    ...
    {
        _progressTintColor = [[UIColor colorWithRed:0.2392f green:0.4313f blue:0.7490f alpha:1.0f] retain];
    }
